...
| `OPENCODE_ENABLE_AUTOUPDATE`          | boolean | Enable desktop updates (disabled by default)      |
...
| `OPENCODE_ENABLE_MODELS_FETCH`        | boolean | Enable remote model fetches (disabled by default) |
| `OPENCODE_ENABLE_CONFIG_NPM_INSTALL`  | boolean | Enable config npm install (disabled by default)   |
